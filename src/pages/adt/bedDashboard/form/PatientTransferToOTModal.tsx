...
const PatientTransferToOTModal = (props: Props) => {
    ...
    return (
        <FormModal
            ...
            title={formatMessage({ id: "patient-transfer-to-ot" })}
            confirmLabel="Submit"
        >
...
export default PatientTransferToOTModal;