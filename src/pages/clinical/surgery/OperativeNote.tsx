...
const OperativeNote = (props: Props) => {
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                        <CustomTextBox
                                            ...
                                            control={control}
                                            error={errors.companyName}
                                            placeholder="As entered in general"
                                            rules={validationRule.textbox({ type: "textWithSpace" })}
                                        />
                                    </Grid>
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                    ...
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                        <CustomTextBox
                                            label={formatMessage({ id: "free text 200 characters" })}
                                            name="companyName"
                                            control={control}
                                            error={errors.companyName}
                                            rules={validationRule.textbox({ type: "textWithSpace" })}
                                    ...
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                        <FormLabel component="legend">{formatMessage({ id: "surgery-course" })} </FormLabel>
                                        <CustomCheckBox
                                            label={formatMessage({ id: "favorable" })}
                                            control={control}
                                            name="isSubvention"
                                        />
                                        <CustomCheckBox
                                            label={formatMessage({ id: "blood-transfusion-required" })}
                                            control={control}
                                            name="isSubvention"
                                        />
                                        <CustomCheckBox
                                            label={formatMessage({ id: "icu-admission-needed" })}
                                            control={control}
                                            name="isSubvention"
                                        />
                                    </Grid>
                                    ...
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                        <CustomTextBox
                                            label={formatMessage({ id: "pathological-anatomy" })}
                                            name="companyName"
                                            control={control}
                                            error={errors.companyName}
                                            placeholder="free text 100 characters"
                                    ...
                                    <Grid item xs={12} lg={12} md={4} sm={12}>
                                        <CustomSelect
                                            options={medicalStaffOptions}
                                            label={formatMessage({ id: "report-received" })}
                                            name="husbandParentsConsanguinityId"
                                            control={control}
                                            error={errors.husbandParentsConsanguinityId}
                                        />
