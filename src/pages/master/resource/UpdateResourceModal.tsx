...
import { CustomCheckBox, CustomColorPicker, CustomTextBox } from 'components/forms';
...
const UpdateResourceModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateResource(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-resource" })}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <CustomColorPicker
                            formLabel={formatMessage({ id: "color-code" })}
                            name="colorCode"
                            control={control}
                            error={errors.colorCode}
                            defaultValue={selectedData?.colorCode}
                        />
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        <CustomCheckBox
                            ...
                            control={control}
                            error={errors.isVisibleInAppointment}
                        />
                    </Grid>
                </Grid>
