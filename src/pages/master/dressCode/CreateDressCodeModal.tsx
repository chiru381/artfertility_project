...
const CreateDressCodeModal = (props: Props) => {
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-dresscode" })}
            >
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "dresscode-name" })}
                            name="code"
                            control={control}
                            error={errors.code}
...
export default CreateDressCodeModal;