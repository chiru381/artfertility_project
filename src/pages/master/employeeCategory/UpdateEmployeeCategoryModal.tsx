...
const UpdateEmployeeCategoryModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateEmployeeCategory(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-employee-category" })}>
...
export default UpdateEmployeeCategoryModal;