...
const CreateEmployeeCategoryModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createEmployeeCategory(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-employee-category" })}
            >
...
export default CreateEmployeeCategoryModal;