...
const CreateDesignationModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createDesignation(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-designation" })}
            >
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            ...
                            control={control}
                            error={errors.name}
                            rules={validationRule.textbox({ required: true, type: "textWithNumber", maxLength: 125 })}
                        />
                    </Grid>
                </Grid>
            </FormModal>
