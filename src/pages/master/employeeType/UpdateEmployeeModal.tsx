...
const UpdateEmployeeTypeModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateEmployeeType(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-employee-type" })}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "employee-type-name" })}
                            name="name"
                            control={control}
                            error={errors.name}
...
export default UpdateEmployeeTypeModal;