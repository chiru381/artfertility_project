...
const UpdateAppointmentTypeModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateAppointmentType(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-appointment-type" })}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "appointment-type" })}
                            name="name"
                            control={control}
                            error={errors.name}
...
export default UpdateAppointmentTypeModal;