...
const CreateMaritalStatusModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createMaritalStatus(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-marital-status" })}
            >
...
export default CreateMaritalStatusModal;