...
const UpdateEncounterStartTypeModal = (props: Props) => {
  ...
  function onSubmit(data: any) {
    ...
    setLoading(true);
    services.updateEncounterStartTypes(bodyData)
      .then((res) => {
        setLoading(false);
  ...
  return (
    <>
      <FormModal
        ...
        title={formatMessage({ id: "update-encounter-start-type" })}
      >
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <CustomTextBox
              label={formatMessage({ id: "start-type" })}
              name="startType"
              control={control}
...
export default UpdateEncounterStartTypeModal;