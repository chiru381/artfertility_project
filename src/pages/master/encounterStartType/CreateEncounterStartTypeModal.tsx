...
const CreateEncounterStartTypeModal = (props: Props) => {
  ...
  function onSubmit(data: any) {
    ...
    setLoading(true);
    services.createEncounterStartTypes(bodyData)
      .then((res) => {
        setLoading(false);
  ...
  return (
    <>
      <FormModal
        ...
        title={formatMessage({ id: "create-encounter-start-type" })}
      >
...
export default CreateEncounterStartTypeModal;