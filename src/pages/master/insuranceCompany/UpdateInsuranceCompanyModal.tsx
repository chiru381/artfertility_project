...
const UpdateInsuranceCompanyModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        // setLoading(true);
        // services.updateInsuranceCompany(bodyData)
        //     .then((res) => {
        //         setLoading(false);
        ...
        <>
            <FormModal
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "compnay-name" })}
                            name="name"
                            control={control}
                            error={errors.name}
                    ...
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "telephone-number" })}
                            name="telephone"
                            control={control}                            
                        />
                    </Grid>
...
export default UpdateInsuranceCompanyModal;