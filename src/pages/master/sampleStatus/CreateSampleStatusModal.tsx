...
const CreateSampleStatusModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createSampleStatus(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-sample-status" })}
            >
...
export default CreateSampleStatusModal;