...
const CreateReferringDoctorModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createReferringDoctor(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-referring-doctor" })}
            >
...
export default CreateReferringDoctorModal;