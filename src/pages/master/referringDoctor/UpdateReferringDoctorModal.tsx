...
const UpdateReferringDoctorModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateReferringDoctor(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-referring-doctor" })}>
...
export default UpdateReferringDoctorModal;