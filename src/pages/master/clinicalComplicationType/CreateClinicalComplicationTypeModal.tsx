...
const CreateClinicalComplicationTypeModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createClinicalComplicationType(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-clinical-complication-type" })}
            >
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "clinical-complication-type" })}
                            name="name"
                            control={control}
                            error={errors.name}
...
export default CreateClinicalComplicationTypeModal;