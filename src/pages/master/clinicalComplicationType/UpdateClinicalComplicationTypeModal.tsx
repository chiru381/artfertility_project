...
const UpdateClinicalComplicationTypeModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateClinicalComplicationType(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-clinical-complication-type" })}>
...
export default UpdateClinicalComplicationTypeModal;