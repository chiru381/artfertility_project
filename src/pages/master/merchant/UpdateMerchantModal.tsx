...
const UpdateMerchantModal = (props: Props) => {
    ...
    useEffect(() => {
        reset(selectedData);
        setMerchantBreakupModels(selectedData?.merchantBreakupModels)
    }, [reset]);
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateMerchant(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-merchant" })}
                modalSize="medium"
            >
