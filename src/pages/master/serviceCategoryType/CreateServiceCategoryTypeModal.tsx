...
const CreateServiceCategoryTypeModal = (props: Props) => {
    ...
    // let serviceCategoryTypeOptions = serviceCategoryTypeData.modelItems?.map((option: any) => ({ label: option.name, value: option.id }));


    function onSubmit(data: any) {
        let bodyData = getFormBody(data);
        setLoading(true);
        services.createServiceCategoryType(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-service-category-type" })}
            >
...
export default CreateServiceCategoryTypeModal;