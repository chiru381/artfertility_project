...
const UpdateRefundReasonModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateRefundReason(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-refund-reason" })}>
...
export default UpdateRefundReasonModal;