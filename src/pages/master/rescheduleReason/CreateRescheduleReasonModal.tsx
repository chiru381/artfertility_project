...
const CreateRescheduleReasonModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createRescheduleReason(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-reschedule-reason" })}
            >
...
export default CreateRescheduleReasonModal;