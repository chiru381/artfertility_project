...
const CreateDiscountTypeModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.createDiscountType(bodyData)
        .then((res) => {
            setLoading(false);
    ...
    return (
        ...
        <FormModal
            ...
            title={formatMessage({ id: "create-discounttype"})}
        >
...
export default CreateDiscountTypeModal;