...
const UpdateEncounterTypeCodeModal = (props: Props) => {
  ...
  function onSubmit(data: any) {
    ...
    setLoading(true);
    services.updateEncounterTypesCode(bodyData)
      .then((res) => {
        setLoading(false);
  ...
  return (
    <>
      <FormModal
        ...
        title={formatMessage({ id: "update-encounter-type-code" })}
      >
...
export default UpdateEncounterTypeCodeModal;