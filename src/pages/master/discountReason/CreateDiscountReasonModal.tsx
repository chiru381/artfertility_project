...
const CreateDiscountReasonModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.creatDiscountReason(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "create-discount-reason" })}
            >
...
export default CreateDiscountReasonModal;