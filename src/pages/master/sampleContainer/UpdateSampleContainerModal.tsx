...
const UpdateSampleContainerModal = (props: Props) => {
    ...
    function onSubmit(data: any) {
        ...
        setLoading(true);
        services.updateSampleContainer(bodyData)
            .then((res) => {
                setLoading(false);
    ...
    return (
        <>
            <FormModal
                ...
                title={formatMessage({ id: "update-sample-container" })}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <CustomTextBox
                            label={formatMessage({ id: "sample-container-name" })}
                            name="name"
                            control={control}
                            error={errors.name}
...
export default UpdateSampleContainerModal;